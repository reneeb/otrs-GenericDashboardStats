...
// PS
// --
        // Initialize generic dashboard ticket stats
        InitGenericDashboardTicketStats();
// --
...
// --
    /**
     * @private
     * @name InitGenericDashboardTicketStats
     * @memberof Core.Agent.Dashboard
     * @function
     * @description
    ...
    function InitGenericDashboardTicketStats () {
        ...
        $('.D3GraphCanvas').each( function( index, element ) {
            ...
            var id      = long_id.replace('GraphWidget','');
     
            var TicketStats = Core.Config.Get('GenericTicketStats-' + id );
            ...
            if (typeof TicketStats !== 'undefined') {
                ...
                window.setTimeout(function () {
                    Core.UI.AdvancedChart.Init(
                        "D3::SimpleLineChart",
                        Core.JSON.Parse(TicketStats.ChartData),
